/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 22d698660bb6cc4c34a1be39defb7549)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		LLM_CLAUDE_MODEL: string;
		LLM_CLAUDE_MODEL_TASTE: string;
		LLM_CLAUDE_MODEL_FAST: string;
		TASTE_PROFILE_CACHE?: KVNamespace;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LLM_IMPORT_MODEL">> {}
}
